...
sweater = "nike tech" 
shoes= "dunks" 
jewlery= "silver chain"
print (f"Hello {name} you are {age} years old, and wearing a {sweater}.")
print (f"Hello {name} you are {age} years old, and wearing cream {shoes}.")
print (f"Hello {name} you are {age} years old, and is wearing a {jewlery}.")

name= "German"
age= 16

print(f"in ten years {name} will be {age +10} years old.")
